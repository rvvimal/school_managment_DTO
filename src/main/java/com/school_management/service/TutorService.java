...
public class TutorService {
    ...
    public ResponseDTO findById(final int id) {
        ...
        return new ResponseDTO(HttpStatus.OK.value(), Constant.RETRIEVE,
                this.tutorRepository.findById(id));
    }
    ...
    public ResponseDTO updateById(final Tutor tutor, final int id) {
        final Tutor tutorObject = this.tutorRepository.findById(id)
        ...
        return new ResponseDTO(HttpStatus.OK.value(), Constant.UPDATE,
                this.tutorRepository.save(tutorObject));
    }
