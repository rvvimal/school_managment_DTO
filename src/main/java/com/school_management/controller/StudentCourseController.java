...
public class StudentCourseController {
    ...
    @GetMapping("/sc/{id}")
    public List<SchoolDetailsDTO> t(@PathVariable int id){
        return this.studentCourseService.sals(id);
    }

    @GetMapping("/scs/{id}")
    public List<SchoolDTO> ts(@PathVariable Integer id){
        return this.studentCourseService.salary(id);
    }
}